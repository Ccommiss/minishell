...
/*   Updated: 2021/12/03 17:48:17 by ccommiss         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				fill_token_buff(t_lex *l, char **to_tok, int *i, t_env *env);
...
int				expand_substitution_error_detector(char *var_name, int except);
...
*/
int				expand_substitution_error_detector(char *var_name, int except);
int				print_expand_errors(int err, char *var_name, char *trimmmed);
void			syntax_error_detector(t_token *toks, int last_tok_is_op);
...
void			ft_exit_program(t_cmd *cmd, t_token *t, char *s, void *stuff);
